...
public class MyFrame extends JFrame {
    ...
    public MyFrame() {
        ...
        JRadioButtonMenuItem item2 = new JRadioButtonMenuItem("智障博弈");
        // item1按钮添加时间并且为匿名类
        ...
        // 游戏难度设置
        JRadioButtonMenuItem item5 = new JRadioButtonMenuItem("究极智障");// 添加按钮
        JRadioButtonMenuItem item6 = new JRadioButtonMenuItem("特智障");
        JRadioButtonMenuItem item7 = new JRadioButtonMenuItem("智障");
        ...
        menu6.addMouseListener(new MouseListener() {
            ...
            public void mousePressed(MouseEvent e) {
                ...
                JOptionPane.showMessageDialog(null, "制作人员：芦凯");
